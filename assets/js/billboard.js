...
$(document).ready(function () {
  ...
  if ($('#billboardjs-chart-4').length) {
    var chart4 = bb.generate({
      data: {
        x: "x",
        columns: [["x", "2020-01-01", "2020-01-02", "2020-01-03", "2020-01-04", "2020-01-05", "2020-01-06"], ["data1", [150, 140, 110], [155, 130, 115], [160, 135, 120], [135, 120, 110], [180, 150, 130], [199, 160, 125]], ["data2", 130, 340, 200, 500, 250, 350]],
        colors: {
          data1: themeColors.accent,
          data2: themeColors.secondary,
          data3: themeColors.orange,
  ...
  if ($('#billboardjs-chart-9').length) {
    var chart9 = bb.generate({
      data: {
        columns: [["data1", 30, 190, 200, 110, 150, 160, 50, 80, 55, 220], ["data2", 130, 100, 10, 143, 80, 50, 200, 123, 185, 98], ["data3", 160, 153, 85, 80, 250, 120, 5, 84, 99, 175]],
        colors: {
          data1: themeColors.accent,
          data2: themeColors.secondary,
          data3: themeColors.orange,
