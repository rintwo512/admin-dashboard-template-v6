...
$(document).ready(function () {
  ...
  if ($('#apex-chart-12').length) {
    var options12 = {
      ...
      xaxis: {
        categories: ['Malaysa', 'India', 'China', 'Indonesia', 'Japan', 'Thailand', 'Vietnam', 'United States', 'Korea', 'Singapore']
      }
    };
  ...
  if ($('#apex-chart-15').length) {
    ...
    var options15 = {
      series: [{
        name: 'Bubble1',
        data: generateData(new Date('11 Feb 2020 GMT').getTime(), 20, {
          min: 10,
          max: 60
        })
      }, {
  ...
  if ($('#apex-chart-16').length) {
    ...
    var options16 = {
      series: [{
        name: 'Team 1',
        data: generateDayWiseTimeSeries(new Date('11 Feb 2020 GMT').getTime(), 20, {
          min: 10,
          max: 60
        })
      }, {
        ...
        name: 'Team 3',
        data: generateDayWiseTimeSeries(new Date('11 Feb 2020 GMT').getTime(), 30, {
          min: 10,
          max: 60
        })
      }, {
